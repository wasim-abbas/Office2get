...
abstract class BaseActivity: AppCompatActivity() {
    ...
    fun replaceMainFragment(action: Int) {
        Navigation.findNavController(this, R.id.navMainHomeHost).navigate(action, null, options)
    }

    fun replaceHostMainFragment(action: Int) {
        Navigation.findNavController(this, R.id.host_home_fragment).navigate(action, null, options)
    }

    fun replaceMainFragment(action: Int, bundle: Bundle) {
        Navigation.findNavController(this, R.id.navMainHomeHost)
